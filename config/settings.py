...
LOCAL_APPS = ["rustyfork.core", "rustyfork.users"]
...
DATABASES = {"default": env.db("DATABASE_URL", default="postgres:///rustyfork")}
...
ACCOUNT_FORMS = {"signup": "rustyfork.users.forms.UserSignupForm"}
